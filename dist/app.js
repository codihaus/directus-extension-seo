...
], Sje = (e) => (pn("data-v-1f1c036c"), e = e(), hn(), e), $je = { class: "navigator h-full flex flex-col" }, Tje = { class: "flex items-center text-slate-700 mr-auto" }, Bje = /* @__PURE__ */ Sje(() => /* @__PURE__ */ U("div", { class: "text-xs mt-auto py-1 px-3" }, "Directus SEO Extensions v1.5.0", -1)), Rje = /* @__PURE__ */ Xe({
  __name: "index",
  props: {
    // items: {
...
const GMe = /* @__PURE__ */ yt(KMe, [["__scopeId", "data-v-d0e6f5bc"]]), YMe = [
  ...ft(
    {
      title: "Custom code",
      field: "custom_code"
