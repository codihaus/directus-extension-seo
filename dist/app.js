...
var ZOe = typeof fn == "object" && fn && fn.Object === Object && fn, Nh = ZOe, JOe = Nh, XOe = typeof self == "object" && self && self.Object === Object && self, QOe = JOe || XOe || Function("return this")(), ei = QOe, e7e = ei, t7e = e7e.Symbol, hl = t7e, Cp = hl, Uh = Object.prototype, n7e = Uh.hasOwnProperty, i7e = Uh.toString, ir = Cp ? Cp.toStringTag : void 0;
function r7e(e) {
  ...
  setup(e, { emit: n }) {
    ...
    return (F, A) => {
      ...
      return H(), fe($t, null, [
        ...
        U("div", I7e, [
          (H(!0), fe($t, null, Yt(m.value, (C, L) => (H(), pe(R7e, {
...
const Wh = /* @__PURE__ */ ut(q7e, [["__scopeId", "data-v-643df86b"]]), N7e = /* @__PURE__ */ Ue({
  __name: "sidebar-seo",
  props: {
    modelValue: {}
  },
...
var ti = U7e, W7e = Array.isArray, Hh = W7e, Sp = hl, Tp = Sp ? Sp.prototype : void 0;
Tp && Tp.toString;
var H7e = ei;
H7e.isFinite;
const V7e = (e, n) => {
  ...
  setup(e, { emit: n }) {
      ...
      try {
        await d.get(`/items/${te.seo_detail}/${b}`).then((E) => {
          ...
          _.value = {
            ...
            meta_keywords: ue,
            ...Je
          }, B.value = ue, C.setSelectedKeyword(ue == null ? void 0 : ue[0]);
        });
      } catch {
      }
    };
    return Nt(() => {
      ...
      for (; E && E.type.__name !== "private-view"; )
        E = E.parent;
      const z = n0(N7e, { modelValue: B }), j = E.slots.sidebar();
