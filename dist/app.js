...
}), X_ = (e) => (un("data-v-f86bbf15"), e = e(), cn(), e), Q_ = ["contenteditable"], e3 = /* @__PURE__ */ X_(() => /* @__PURE__ */ U("span", { class: "text" }, null, -1)), t3 = [
  e3
], n3 = ["innerHTML"], i3 = /* @__PURE__ */ Ue({
        ...
        activator: W(({ toggle: Z }) => [
          q(z, { disabled: A.disabled }, {
            input: W(() => [
              ...
              A.placeholder && !A.modelValue ? (H(), pe("span", {
                key: 0,
                class: "placeholder",
...
const r3 = /* @__PURE__ */ st(i3, [["__scopeId", "data-v-f86bbf15"]]), a3 = { class: "system-display-template" }, s3 = /* @__PURE__ */ Ue({
  __name: "interface",
  props: {
    value: {},
    disabled: { type: Boolean },
...
], T6e = (e) => (un("data-v-1f1c036c"), e = e(), cn(), e), B6e = { class: "navigator h-full flex flex-col" }, $6e = { class: "flex items-center text-slate-700 mr-auto" }, O6e = /* @__PURE__ */ T6e(() => /* @__PURE__ */ U("div", { class: "text-xs mt-auto py-1 px-3" }, "Directus SEO Extensions v1.3.2", -1)), R6e = /* @__PURE__ */ Ue({
  __name: "index",
  props: {
    // items: {
